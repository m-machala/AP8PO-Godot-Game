...
public partial class Level3 : Level
{
	...
	public override void _Ready()
	{
		...
		var mainEnemy = (ShootingEnemy)GD.Load<PackedScene>("res://Levels/Level3/Enemy1.tscn").Instantiate();
		game parent = (game)GetParent();
		playerInstance.Connect("Died", new Callable(parent, nameof(parent.Die)));
		mainEnemy.projectile = GD.Load<PackedScene>("res://Levels/Level3/Missile.tscn");
		mainEnemy.Position = new Vector2(100, 100);
		mainEnemy.size = 4f;
		mainEnemy.hostile = true;
		AddChild(mainEnemy);

		mainFood = (StationaryFood)GD.Load<PackedScene>("res://Levels/Level3/Food6.tscn").Instantiate();
	...
	public void LoadFoodScenes() {
		stationaryFoodScenes.Add((GD.Load<PackedScene>("res://Levels/Level3/Food1.tscn"), 0.5));
		stationaryFoodScenes.Add((GD.Load<PackedScene>("res://Levels/Level3/Food2.tscn"), 0.85));
		stationaryFoodScenes.Add((GD.Load<PackedScene>("res://Levels/Level3/Food3.tscn"), 1.1));
		stationaryFoodScenes.Add((GD.Load<PackedScene>("res://Levels/Level3/Food4.tscn"), 2));
		stationaryFoodScenes.Add((GD.Load<PackedScene>("res://Levels/Level3/Food5.tscn"), 2.2));
	}
